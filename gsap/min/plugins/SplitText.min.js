...
!function(a) {
    ...
    var b = a.GreenSockGlobals || a
      ...
      , v = d.SplitText = b.SplitText = function(b, c) {
        if ("string" == typeof b && (b = v.selector(b)),
        !b)
            throw "cannot split a null element.";
        return u ? (this.elements = j(b) ? k(b) : [b],
        this.chars = [],
        this.words = [],
        this.lines = [],
        this._originals = [],
        this.vars = c || {},
        this.split(c),
        void 0) : (a.location.href = "http://" + s + t + "?plugin=" + r + "&source=" + q,
        !1)
    }
      , w = function(a, b, c) {
        var d = a.nodeType;
      ...
      , y = function(a, b, c, d, h) {
        ...
        var P, Q, R, S, T, U, V, W, X, Y, Z, $, _, ab, j = e(a), k = b.type || b.split || "chars,words,lines", n = -1 !== k.indexOf("lines") ? [] : null , o = -1 !== k.indexOf("words"), q = -1 !== k.indexOf("chars"), r = "absolute" === b.position || b.absolute === !0, s = r ? "&#173; " : " ", t = -999, u = g(a), v = i(a, "paddingLeft", u), y = i(a, "borderBottomWidth", u) + i(a, "borderTopWidth", u), z = i(a, "borderLeftWidth", u) + i(a, "borderRightWidth", u), A = i(a, "paddingTop", u) + i(a, "paddingBottom", u), B = i(a, "paddingLeft", u) + i(a, "paddingRight", u), C = i(a, "textAlign", u, !0), D = a.clientHeight, E = a.clientWidth, F = "</div>", G = p(b.wordsClass), H = p(b.charsClass), I = -1 !== (b.linesClass || "").indexOf("++"), J = b.linesClass, K = -1 !== j.indexOf("<"), L = !0, M = [], N = [], O = [];
        for (I && (J = J.split("++").join("")),
        K && (j = j.split("<").join("{{LT}}")),
        P = j.length,
        S = G(),
        T = 0; P > T; T++)
            ...
            ")" === V && j.substr(T, 20) === l)
                ...
                L = !1; " " === j.charAt(T + 1); )
                    S += s,
                    T++;
                (")" !== j.charAt(T + 1) || j.substr(T + 1, 20) !== l) && (S += s + G(),
                L = !0)
            } else
                S += q && " " !== V ? H() + V + "</div>" : V;
        for (a.innerHTML = S + (L ? F : ""),
        K && w(a, "{{LT}}", "<"),
        ...
        if (n || r)
            for (T = 0; P > T; T++)
                X = W[T],
                R = X.parentNode === a,
                (R || r || q && !o) && (Y = X.offsetTop,
                n && R && Y !== t && "BR" !== X.nodeName && (Q = [],
                n.push(Q),
                t = Y),
                r && (X._x = X.offsetLeft,
                X._y = Y,
                ...
                n && (o !== R && q || (Q.push(X),
                X._x -= v),
                R && T && (W[T - 1]._wordEnd = !0),
                "BR" === X.nodeName && X.nextSibling && "BR" === X.nextSibling.nodeName && n.push([])));
        for (T = 0; P > T; T++)
            X = W[T],
            R = X.parentNode === a,
            "BR" !== X.nodeName ? (r && ($ = X.style,
            o || R || (X._x += X.parentNode._x,
            ...
            $.width = X._w + 1 + "px",
            $.height = X._h + "px"),
            o ? R && "" !== X.innerHTML ? N.push(X) : q && M.push(X) : R ? (a.removeChild(X),
            W.splice(T--, 1),
            P--) : !R && q && (Y = !n && !r && X.nextSibling,
            a.appendChild(X),
            Y || a.appendChild(f.createTextNode(" ")),
            M.push(X))) : n || r ? (a.removeChild(X),
            W.splice(T--, 1),
            P--) : o || a.appendChild(X);
        if (n) {
            for (r && (Z = f.createElement("div"),
            a.appendChild(Z),
            _ = Z.offsetWidth + "px",
            ...
            T = 0; T < n.length; T++) {
                ...
                Z.style.cssText = "display:block;text-align:" + C + ";position:" + (r ? "absolute;" : "relative;"),
                J && (Z.className = J + (I ? T + 1 : "")),
                O.push(Z),
                P = Q.length,
                U = 0; P > U; U++)
                    "BR" !== Q[U].nodeName && (X = Q[U],
                    Z.appendChild(X),
                    ab && (X._wordEnd || o) && Z.appendChild(f.createTextNode(" ")),
                    r && (0 === U && (Z.style.top = X._y + "px",
                    Z.style.left = v + Y + "px"),
                    X.style.top = "0px",
        ...
        r && (D > a.clientHeight && (a.style.height = D - A + "px",
        a.clientHeight < D && (a.style.height = D + y + "px")),
        E > a.clientWidth && (a.style.width = E - B + "px",
        a.clientWidth < E && (a.style.width = E + z + "px"))),
        x(c, M),
        x(d, N),
        x(h, O)
    }
